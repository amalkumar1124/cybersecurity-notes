...
#### 10.HTTP headers, methods, and page title gathering
...
#### 14.MySQL diagnostic metadata

nmap -p 3306 --script mysql-info,mysql-databases 192.168.1.1

#### 15.Run all discovery-class scripts at once
...
#### 3.Spoof Source Port (forces scan to come from a common trusted port, e.g., DNS port 53)

nmap -g 53 192.168.1.1

#### 4.Spoof Source IP (makes the target think the scan is coming from a different address)

nmap -S 10.0.0.5 -e eth0 192.168.1.1

#### 5.Decoy Scan (mixes your IP with random spoofed decoy IPs so defenders can't tell who started it)

nmap -D RND:10 192.168.1.1

#### 6.Append random data to sent packets (pads payload size to look like normal traffic)
